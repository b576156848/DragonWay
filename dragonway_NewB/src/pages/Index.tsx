...
import TrustMoatSection from '@/components/dragonway/TrustMoatSection';
      ...
      <header className="border-b border-border/50 bg-background/90 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-muted-foreground text-xs hidden sm:inline">{t('headerSubtitle')}</span>
          </div>
      ...
      {stage === 'input' && (
        <>
          ...
          <div className="max-w-5xl mx-auto px-4 pt-16 pb-8">
            <HeroSection onDemoMode={handleDemoMode} onSeeHow={scrollToCta} />
          </div>
