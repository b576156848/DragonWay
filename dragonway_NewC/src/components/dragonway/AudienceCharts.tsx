...
const AudienceCharts = ({ audience }: { audience: AudienceData }) => {
  ...
  return (
    <section className="mb-12">
      <h2 className="text-xl font-bold text-foreground mb-1">{t('audienceTitle')}</h2>
      <p className="text-sm text-muted-foreground mb-6">{t('audienceSubtitle')}</p>
      ...
      >
        ...
        <ChartCard title={t('audienceCity')}>
          <ResponsiveContainer width="100%" height={200}>
      ...
      >
        <ChartCard title={t('audienceSpending')}>
          <ResponsiveContainer width="100%" height={200}>
        ...
        <ChartCard title={t('audienceInterest')}>
